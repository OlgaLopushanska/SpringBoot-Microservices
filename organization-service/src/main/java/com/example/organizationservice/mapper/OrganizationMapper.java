...
public class OrganizationMapper {
    ...
    public static OrganizationDto mapToOtganizationDto(Organization organization) {
    ...
    public static Organization mapToOrganizaton(OrganizationDto organizationDto) {
